...
export default class ProfilePage extends React.Component {
    ...
    componentDidMount() {
        ...
        userService.getLoggedUser().then(user => this.setState({ user: user })).then(() => 
    ...
    render() {
        ...
        <h2 className="t11-title-Exo bold-text">{this.state.user.username}</h2>
                            <br/>
                            ...
                            <h5 className="col-8 text-align-left">Roles: {this.state.user.roles[0].authority}</h5>
